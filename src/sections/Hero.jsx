...
import {shoes, statistics} from '../conts'
...
const Hero = () => {
  ...
  return (
    ...
    <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
      ...
      <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[5.5rem] font-bold">
      <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">The New Arrival </span>
        <br />
      <span className="text-coral-red inlne-block mt-3">Nike</span> Shoes
      </h1>
  ...
  <Button label= 'Shop from me now' iconURL={arrowRight}/>

  <div className="flex items-start flex-wrap w-full mt-20 justify-start gap-16">
...
<div className="relative flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-center">
  <img src={bigShoeImg} alt="nike shoes" width={610} height={502}
